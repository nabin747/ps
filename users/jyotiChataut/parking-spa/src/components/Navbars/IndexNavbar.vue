<template>
  <nav
    class="top-0 bg-pink-400 fixed z-50 w-full flex flex-wrap items-center justify-between px-2  navbar-expand-lg shadow"
  >
    <div
    ...
    >
      ...
      >
        ...
        <img style="height: 50px;" src="../../assets/img/hackathonlogo.png" alt="Logo" /> 
      </div>
             <!-- Easy parking -->
            </a>
        </router-link>
